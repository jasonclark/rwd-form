...
$pageTitle = 'Code: Get Your Knowledge Card';
...
<div class="main">
<main role="main">
<h2 class="mainHeading">Code for the responsive web design (rwd) form example</h2>
<p>Source code here is the CSS and HTML from the example form showing how to responsively design a web form for the book, <i>Responsive Web Design (RWD) in Practice</i>.</p>
<p><a href="index.txt" title="html markup for web form">HTML markup for responsive web design (rwd) form example</a></p>
<p><a href="master.txt" title="css rules and declarations for web form">CSS rules and declarations for responsive web design (rwd) form example</a></p>
</main>
</div><!--end .main div-->
